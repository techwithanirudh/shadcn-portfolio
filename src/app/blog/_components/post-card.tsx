    ...
    >
      <CardContent className="p-4 md:p-6">
        <div className="grid gap-2">
          ...
          <TextReveal as='h3' className="text-xl font-bold">{title}</TextReveal>
          <TextReveal as="p" className="text-sm text-gray-500 dark:text-gray-400">{description || ''}</TextReveal>
          <TextReveal as="p" className="text-sm text-gray-500 dark:text-gray-400">{date.toDateString()}</TextReveal>
